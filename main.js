window.onload=(e) => {
  ...
  function create_variable(){
    div_actions.innerHTML='<form id="form-variable">'+
      ...
      document.getElementById("btn-form-variable").addEventListener("click",function(){
        ...
        widgets_algo.push({x:75-15,y:50-15,text:"int x = 2",isDragging:false});
      });
  }
  ...
  function create_affectation(){
    div_actions.innerHTML='<form id="form-affectation">'+
      ...
      document.getElementById("btn-form-affectation").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"x = 2",isDragging:false});
      });
  }
  ...
  function create_print(){
    div_actions.innerHTML='<form id="form-print">'+
      ...
      document.getElementById("btn-form-print").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"print()",isDragging:false});
      });
  }
  ...
  function create_if(){
    div_actions.innerHTML='<form id="form-if">'+
      ...
      document.getElementById("btn-form-variable").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"if",isDragging:false});
      });
  }
  ...
  function create_else_if(){
    div_actions.innerHTML='<form id="form-if">'+
      ...
      document.getElementById("btn-form-variable").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"else if()",isDragging:false});
      });
  }
  ...
  function create_else(){
    div_actions.innerHTML='<form id="form-if">'+
      ...
      '<button id="btn-form-variable" style="background-color:green;color:white">Create if</button>'+
      '</form>';
      widgets_algo.push({x:75-15,y:50-15,text:"else",isDragging:false});
  }
  ...
  function create_function(){
    div_actions.innerHTML='<form id="form-function">'+
      ...
      document.getElementById("btn-form-function").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"function",isDragging:false});
      });
  }
  ...
  function create_function_call(){
    div_actions.innerHTML='<form id="form-function-call">'+
      ...
      document.getElementById("btn-form-function-call").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"f call",isDragging:false});
      });
  }
  ...
  function create_for_loop(){
    ...
    document.getElementById("btn-form-for-loop").addEventListener("click",function(){
        console.log("yes");
        widgets_algo.push({x:75-15,y:50-15,text:"for",isDragging:false});
      });
  }
  ...
  function create_while_loop(){
    ...
    document.getElementById("btn-form-variable").addEventListener("click",function(){
      console.log("yes");
      widgets_algo.push({x:75-15,y:50-15,text:"while",isDragging:false});
    });
  }
  ...
  document.getElementById("btn-new-file").addEventListener("click",function(){
    div_actions.innerHTML='<form id="form-file">'+
  ...
  var widgets_algo=[];
  widgets_algo.push({x:75-15,y:50-15,text:"Start",type:"oval",isDragging:false});
  widgets_algo.push({x:75-25,y:50-25,text:"End",type:"oval",isDragging:false});
  ...
  // draw a single rect
  function draw_rect(mx,my,x,y,text) {
    ctx.beginPath();
    ctx.rect(x,y,WIDTH_WIDGET,HEIGHT_WIDGET);
    if(ctx.isPointInPath(mx,my)){
      ctx.fillStyle="red";
      var myImage = new Image(100,100);
      myImage.src = "images/close.png";
      ctx.drawImage(myImage,x+OFFSET_X_TEXT_WIDGET+10,y); 
    }
    else{
      ctx.fillStyle="white";
    }
  ...
  function draw_canvas(mx,my){
    ...
    for(var i=0;i<widgets_algo.length;i++){
      var widget=widgets_algo[i];
        draw_rect(mx,my,widget.x,widget.y,widget.text);
      //}
    }
  }
  ...
  function mouse_down(e){
    ...
    for(var i=0;i<widgets_algo.length;i++){
      var widget=widgets_algo[i];
      if(mx>widget.x && mx<widget.x+WIDTH_WIDGET && my>widget.y && my<widget.y+HEIGHT_WIDGET){
        dragok=true;
